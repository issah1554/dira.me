...
- [x] The modal dialogs should be in header footer and body(scrollable ) 
      so as it does not escape the view port

- [x] Support offline usage and sync automatically when connected back

...
export function DatePicker({
    ...
    const colorClasses = {
        ...
        light: {
            input: "bg-transparent border border-light text-main placeholder-light/60 focus:ring-light",
            label: `${labelBgColor ?? "bg-white"} dark:bg-gray-900`,
            text: "text-light",
            icon: "text-light",
        },
        dark: {
            input: "bg-transparent border border-dark text-main placeholder-dark/60 focus:ring-dark",
            label: `${labelBgColor ?? "bg-white"} dark:bg-gray-900`,
            text: "text-dark",
            icon: "text-dark",
        },
    ...
    // Date inputs always have fixed content/calendar icon, so label floats to avoid overlap
    ...
    return (
        <div className={`flex flex-col gap-1 items-start text-left w-full my-3 ${className}`}>
            <div className="relative w-full flex items-center">
                ...
                {/* Trailing Controls (Calendar icon, Clear button) */}
